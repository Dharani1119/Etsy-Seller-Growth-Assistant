...
st.set_page_config(
    page_title="GrowthPulse — Etsy AI Coach",
    page_icon="⚡",
    layout="wide",
...
/* ── GrowthPulse persistent watermark (bottom-right) ── */
.gp-watermark {
    position: fixed;
    bottom: 18px;
    right: 20px;
...
# ── Persistent GrowthPulse watermark — injected once, always visible ──────
st.markdown("""
<div class="gp-watermark">
    <div class="gp-watermark-icon">⚡</div>
    <div>
        <div class="gp-watermark-text">GrowthPulse</div>
...
if st.session_state.page == "landing":
    ...
    <div style="text-align:center;max-width:620px;margin:0 auto;">
        <div style="display:inline-flex;align-items:center;gap:8px;
            ...
            ⚡ GrowthPulse — AI Etsy Business Coach
        </div>
    ...
    <div style="text-align:center;border-top:1px solid rgba(255,255,255,0.05);
        ...
        <div style="font-size:11px;color:#374151;margin-top:2px;">
            © 2025 GrowthPulse · All rights reserved · Unauthorized resale or redistribution prohibited
        </div>
    </div>""")
